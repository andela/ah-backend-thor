...
urlpatterns = [
    ...
    path('add_rates/<slug>', RateCreateAPIView.as_view(), name='add_article_ratings'),
    path('view_rates/<slug>', RateRetrieveAPIView.as_view(), name= 'view_average_article_ratings'),
    path('<int:pk>/like_status', LikeArticlesView.as_view(), name='view_article_like_status')
]
